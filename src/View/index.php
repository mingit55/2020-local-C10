        ...
        <div id="visual">
            ...
            <div class="position-center">
                <div class="text-right font-weight-lighter text-gold fx-5 segoe">for Cutsomer</div>
                <div class="text-white font-weight-bolder segoe fx-8 mt-n4">INERIOR</div>
                    ...
                    <div class="inner">
                        ...
                        <div class="back bg-white py-5 d-flex flex-column-reverse">
                            <div class="d-flex flex-column align-items-center">
                                ...
                                <hr style="width: 50px;">
                                <button class="px-4 py-2 text-white bg-blue">
                                    자세히 보기
                                </button>
                            </div>
                        </div>
    ...
    <div class="pt-5 text-center">
        <button class="px-5 py-3 text-white text-whie bg-gold">
            더 보기 +
        </button>
    </div>
    <!-- /전문가 소개 -->
            ...
            <div class="col-lg-6 mb-5">
                <div class="review-item p-lg-3 border">
                    ...
                    <div class="text py-3 px-4">
                        ...
                        <div class="mt-4 text-ellipsis fx-n2 text-muted">
