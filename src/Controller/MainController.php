...
class MainController {
    ...
    function writeKnowhow(){
        ...
        DB::query("INSERT INTO knowhows(uid, before_img, after_img, contents) VALUES (?, ?, ?, ?)", [user()->id, $before_img, $after_img, $contents]);
    ...
    function estimatePage(){
        ...
        $reqList = DB::fetchAll($sql, [user()->user_id]);


        $sql = "SELECT DISTINCT S.*, user_name, user_id, contents, start_date, sid
                FROM responses S
